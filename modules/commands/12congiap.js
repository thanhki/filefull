	...
	switch(event.body){
		case "1":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/tí.gif`)
		...
		case "2":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/suu.gif`)
			}, event.threadID, event.messageID);
			break;
		case "3":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/dan.gif`)
			}, event.threadID, event.messageID); 
			break;
		case "4":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/mao.gif`)
			}, event.threadID, event.messageID); 
			break;
		case "5":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/thin.gif`)
			}, event.threadID, event.messageID); 
			break;
		case "6":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/tị.gif`)
			}, event.threadID, event.messageID); 
			break;
		case "7":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/ngo.gif`)
			}, event.threadID, event.messageID); 
			break;
		case "8":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/mui.gif`)
			}, event.threadID, event.messageID); 
			break;
		case "9":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/than.gif`)
			}, event.threadID, event.messageID); 
			break;
		case "10":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/dau.gif`)
			}, event.threadID, event.messageID); 
			break;
		case "11":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/tuat.gif`)
			}, event.threadID, event.messageID); 
			break;
		case "12":
			api.sendMessage({
				...
				attachment: fs.createReadStream(__dirname + `/noprefix/hoi.gif`)
			}, event.threadID, event.messageID); 
			break;
		default:
	}
...
module.exports.handleEvent = function({ api, event}) {
	if (event.body.indexOf("12 con giáp")==0 || (event.body.indexOf("12 con giáp")==0)) {
		api.sendMessage({
			...
			//attachment: fs.createReadStream(__dirname + `/cache/12congiap.jpeg`)
